...
export default function LimitedOffer() {
  ...
  return (
    <section className="relative w-full overflow-x-hidden ">
      {/* Background banner */}
      <div className="absolute top-0 bg-primary w-full h-[20%]"></div>

      <div data-aos = 'zoom-out'
        className="relative w-full md:w-[90%] mx-auto bg-gradient-to-br from-gray-300 to-bg 
                   flex flex-col xl:flex-row xl:items-center justify-between py-6 md:py-10 px-4 
                   md:px-6 lg:px-10 xl:px-20 rounded-lg aspect-square overflow-hidden xl:aspect-[5/2] resize "
      >
        {/* Left text */}
      ...
      {/* Logo section */}
      <div
        className="flex flex-wrap justify-evenly items-center gap-6 md:gap-8  py-[150px] w-full"
        data-aos="slide-left"
      >
